...
test("all 342 canonical tools route to an implemented workbench family", () => {
  ...
  const implemented = new Set([
    ...
    ...productivityToolSlugs, ...precisionToolSlugs, ...frontierToolSlugs, ...stageTwoToolSlugs, ...studioToolSlugs, ...insightToolSlugs,
  ]);
...
test("the complete 354-tool catalog has unique identities and four-language guidance", () => {
