...
| Measure | Result |
| --- | ---: |
| Canonical tools retained | 342 |
| Localized canonical pages retained and indexable | 1368 |
| Languages per tool | 4 |
| Tool-specific input/method/output/verification/boundary contracts | 1368 |
