# AdSense remediation — Stage 3 usability report
...
| --- | ---: |
| Canonical tools | 342 |
| Localized canonical pages carrying the Stage 3 contract | 1368 |
| Deep-runtime workbenches retained | 110 |
| Four-locale frontier demo runs | 300 |
| key=value tools upgraded to guided fields | 20 |
| delimiter-row tools upgraded to an editable row interface | 12 |
| frontier tools keeping appropriate raw text/JSON/CSV entry | 43 |
