...
assert.match(llms, /342 distinct browser tools/);
assert.match(inventory, /Public canonical tools \| 342/);
...
assert.equal(toolUrls.length, 342 * 4, "sitemap must contain every canonical tool in all four locales");
...
console.log("Editorial index: 342 distinct tools and all localized community/news landing pages are discoverable.");
