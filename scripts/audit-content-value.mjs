...
assert.match(llms, /327 distinct browser tools/);
assert.match(inventory, /Public canonical tools \| 327/);
...
assert.equal(toolUrls.length, 327 * 4, "sitemap must contain every canonical tool in all four locales");
...
console.log("Editorial index: 327 distinct tools and all localized community/news landing pages are discoverable.");
