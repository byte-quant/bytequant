...
for (const pathName of ["/ajan/", "/en/agent/", "/de/agent/", "/zh/agent/", "/is-istasyonu/", "/en/workstation/", "/de/workstation/", "/zh/workstation/", "/de/references/regex-cheat-sheet/", "/zh/references/cron-cheat-sheet/", "/de/blog/local-prompt-text-date-workflow/", "/zh/blog/loan-ai-rubric-csp-workflow/", "/araclar/yaml-json-donusturucu/", "/en/tools/hreflang-etiket-olusturucu/", "/de/tools/hmac-olusturucu-dogrulayici/", "/zh/tools/prompt-enjeksiyon-on-taramasi/", "/araclar/prompt-test-vaka-matrisi/", "/en/tools/data-uri-donusturucu/", "/de/tools/http-guvenlik-basliklari-denetleyici/", "/de/blog/technical-seo-robots-hreflang-faq-utm-workflow/", "/zh/blog/web-crypto-rag-prompt-injection-security-workflow/", "/de/blog/browser-only-agentic-ai-tool-orchestration/", "/zh/blog/browser-only-agentic-ai-tool-orchestration/", "/de/blog/visual-workflow-indexeddb-webrtc-workstation/", "/zh/blog/visual-workflow-indexeddb-webrtc-workstation/"]) {
