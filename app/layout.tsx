...
export const metadata: Metadata = {
  ...
  description: "Prompt, metin, hesaplama, veri, PDF, görsel, yapay zekâ ve güvenlik işlemlerini tarayıcınızda tamamlayan 53 ücretsiz araç.",
  applicationName: "ByteQuant",
  authors: [{ name: "ByteQuant Editorial", url: "https://bytequant.org/hakkimizda" }],
  creator: "ByteQuant",
  publisher: "ByteQuant",
  formatDetection: { email: false, address: false, telephone: false },
  openGraph: { type: "website", siteName: "ByteQuant", locale: "tr_TR", alternateLocale: ["en_US", "de_DE", "zh_CN"], url: "https://bytequant.org", title: "ByteQuant · Gizlilik Odaklı Tarayıcı İçi Araçlar", description: "53 ücretsiz araç. Üyelik yok, yükleme yok; çekirdek işlemler cihazınızda.", images: [{ url: "/og.png", width: 1200, height: 630, alt: "ByteQuant gizlilik odaklı tarayıcı içi araçlar" }] },
