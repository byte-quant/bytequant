...
export const metadata: Metadata = {
  ...
  description: "Prompt, metin, veri ve güvenlik işlemlerini tarayıcınızda tamamlayan 33 ücretsiz ve gizlilik odaklı araç.",
  applicationName: "ByteQuant",
  authors: [{ name: "ByteQuant Editorial", url: "https://bytequant.org/hakkimizda" }],
  creator: "ByteQuant",
  publisher: "ByteQuant",
  formatDetection: { email: false, address: false, telephone: false },
  openGraph: { type: "website", siteName: "ByteQuant", locale: "tr_TR", alternateLocale: "en_US", url: "https://bytequant.org", title: "ByteQuant · Gizlilik Odaklı Tarayıcı İçi Araçlar", description: "33 ücretsiz araç. Üyelik yok, yükleme yok; temel işlemler cihazınızda.", images: [{ url: "/og.png", width: 1200, height: 630, alt: "ByteQuant gizlilik odaklı tarayıcı içi araçlar" }] },
