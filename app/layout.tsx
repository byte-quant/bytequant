...
export const metadata: Metadata = {
  ...
  description: "Prompt, metin, hesaplama, veri, PDF, görsel, araştırma, yapay zekâ ve güvenlik işlemlerini tarayıcınızda tamamlayan 186 ücretsiz araç.",
  ...
  openGraph: { type: "website", siteName: "ByteQuant", locale: "tr_TR", alternateLocale: ["en_US", "de_DE", "zh_CN"], url: "https://bytequant.org", title: "ByteQuant · Yerel İş İstasyonu ve 186 Tarayıcı Aracı", description: "186 ücretsiz araç, açıklanabilir çok adımlı planlar, şifreli cihaz içi projeler ve sunucusuz P2P. Üyelik, veri yükleme ve uzak model yok.", images: [{ url: "/og.png", width: 1200, height: 630, alt: "ByteQuant Yerel İş İstasyonu: JSON doğrulama, hassas veri maskeleme ve CSV hazırlama akışı" }] },
  twitter: { card: "summary_large_image", title: "ByteQuant · Yerel İş İstasyonu + 186 Araç", description: "Görsel akışlar, çok adımlı yerel AI planlama, şifreli cihaz içi projeler ve güven kodlu P2P.", images: ["/og.png"] },
