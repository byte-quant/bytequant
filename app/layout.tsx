...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", siteName: "ByteQuant", locale: "tr_TR", alternateLocale: ["en_US", "de_DE", "zh_CN"], url: "https://bytequant.org", title: "ByteQuant · Yerel İş İstasyonu ve 317 Tarayıcı Aracı", description: "317 benzersiz ücretsiz araç, açıklanabilir çok adımlı planlar, şifreli cihaz içi projeler ve sunucusuz P2P. Üyelik, veri yükleme ve uzak model yok.", images: [{ url: "/og.png", width: 1200, height: 630, alt: "ByteQuant Yerel İş İstasyonu: JSON doğrulama, hassas veri maskeleme ve CSV hazırlama akışı" }] },
