...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", siteName: "ByteQuant", locale: "tr_TR", alternateLocale: "en_US", url: "https://bytequant.org", title: "ByteQuant · Gizlilik Odaklı Tarayıcı İçi Araçlar", description: "29 ücretsiz araç. Üyelik yok, yükleme yok; temel işlemler cihazınızda.", images: [{ url: "/og.png", width: 1200, height: 630, alt: "ByteQuant gizlilik odaklı tarayıcı içi araçlar" }] },
