...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", siteName: "ByteQuant", locale: "tr_TR", alternateLocale: ["en_US", "de_DE", "zh_CN"], url: "https://bytequant.org", title: "ByteQuant · Gizlilik Odaklı Tarayıcı İçi Araçlar", description: "89 ücretsiz araç. Üyelik yok, yükleme yok; çekirdek işlemler cihazınızda.", images: [{ url: "/og-v2.png", width: 1200, height: 630, alt: "ByteQuant gizlilik odaklı tarayıcı içi araçlar" }] },
  twitter: { card: "summary_large_image", title: "ByteQuant", description: "Gizlilik odaklı, tarayıcı içinde çalışan ücretsiz araçlar.", images: ["/og-v2.png"] },
