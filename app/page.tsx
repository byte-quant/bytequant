...
const description = "Prompt, metin, hesaplama, PDF, görsel, geliştirici, araştırma, AI ve güvenlik işlemleri için 342 benzersiz ücretsiz araç. Üyelik yok; temel işlemler tarayıcınızda.";
