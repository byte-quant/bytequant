...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return { title: guide.title.en, description: guide.description.en, alternates: localizedAlternates("en", referencePath("tr", guide.slug), referencePath("en", guide.slug)), openGraph: { type: "article", locale: "en_US", url: `${siteUrl}${referencePath("en", guide.slug)}`, title: guide.title.en, description: guide.description.en } };
}
