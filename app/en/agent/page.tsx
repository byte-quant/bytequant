...
const description = "Describe an outcome and create an explainable, user-controlled workflow across 317 distinct ByteQuant tools with no remote model or data upload.";
