...
const description = "Describe an outcome and create an explainable, user-controlled workflow across 186 ByteQuant tools with no remote model or data upload.";
