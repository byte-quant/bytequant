...
const description = "Describe an outcome and create an explainable, user-controlled workflow across 309 distinct ByteQuant tools with no remote model or data upload.";
