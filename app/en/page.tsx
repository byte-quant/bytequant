...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", siteName: "ByteQuant", locale: "en_US", alternateLocale: ["tr_TR", "de_DE", "zh_CN"], url: absoluteUrl("/en"), title: "ByteQuant · Privacy-First In-Browser Tools", description: "53 free calculation, AI, PDF, image, data, text, and security tools. No account or server uploads; core processing stays on-device.", images: [{ url: ogImageUrl, width: 1200, height: 630, alt: "ByteQuant privacy-first in-browser tools" }] },
  twitter: { card: "summary_large_image", title: "ByteQuant · Privacy-First In-Browser Tools", description: "53 free tools with core processing in your browser.", images: [ogImageUrl] },
};
