...
const description = "Explore 342 free in-browser tools for text, data, PDF, images, calculations, code, and privacy. Search, choose a category, and start without an account.";
