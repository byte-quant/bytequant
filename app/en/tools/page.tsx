...
const description = "Explore 327 free in-browser tools for text, data, PDF, images, calculations, code, and privacy. Search, choose a category, and start without an account.";
