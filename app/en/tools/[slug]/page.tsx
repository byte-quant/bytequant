...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return { title: tool.title.en, description: tool.short.en, alternates: { canonical: toolPath("en", slug), languages: { "tr-TR": toolPath("tr", slug), "en-US": toolPath("en", slug) } }, openGraph: { type: "website", locale: "en_US", url: `${siteUrl}${toolPath("en", slug)}`, title: `${tool.title.en} · ByteQuant`, description: tool.short.en } };
}
