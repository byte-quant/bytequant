...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", siteName: "ByteQuant", locale: "en_US", alternateLocale: ["tr_TR", "de_DE", "zh_CN"], url: absoluteUrl("/en/blog"), title: "ByteQuant Guides", description: "Evidence-led guides to privacy, technical SEO, and in-browser workflows.", images: [{ url: absoluteUrl("/og.png"), width: 1200, height: 630, alt: "ByteQuant guides and multi-step local workstation" }] },
