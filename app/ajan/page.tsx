...
const description = "Hedefinizi doğal dille yazın; ByteQuant'ın 186 aracında tamamen tarayıcı içi, açıklanabilir ve kullanıcı denetimli çok adımlı bir plan oluşturun.";
