...
const description = "Hedefinizi doğal dille yazın; ByteQuant'ın 234 benzersiz aracında tamamen tarayıcı içi, açıklanabilir ve kullanıcı denetimli çok adımlı bir plan oluşturun.";
