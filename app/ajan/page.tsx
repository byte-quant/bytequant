...
const description = "Hedefinizi doğal dille yazın; ByteQuant'ın 211 aracında tamamen tarayıcı içi, açıklanabilir ve kullanıcı denetimli çok adımlı bir plan oluşturun.";
