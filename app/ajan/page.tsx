...
const description = "Hedefinizi doğal dille yazın; ByteQuant'ın 89 aracında tamamen tarayıcı içi, açıklanabilir ve kullanıcı denetimli çok adımlı bir plan oluşturun.";
