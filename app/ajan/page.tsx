...
const description = "ByteQuant AI ile sohbet edin, doğru aracı bulun, desteklenen işleri otomatikleştirin ve görselleri cihazınızda düzenleyin; içerik uzak bir AI API'sine gönderilmez.";
