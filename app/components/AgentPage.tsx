...
const content = {
  tr: {
    ...
    badges: ["104 araçla senkronize", "0 uzak model çağrısı", "Görünür karar özeti"],
  ...
  en: {
    ...
    badges: ["Synced with 104 tools", "0 remote model calls", "Visible decision summary"],
  ...
  de: {
    ...
    badges: ["Mit 104 Werkzeugen synchronisiert", "0 Remote-Modellaufrufe", "Sichtbare Entscheidungsübersicht"],
  ...
  zh: {
    ...
    badges: ["同步 104 个工具", "0 次远程模型调用", "决策摘要可见"],
