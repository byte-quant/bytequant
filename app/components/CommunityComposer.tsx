...
export function CommunityComposer({ locale }: { locale: Locale }) {
  const t = copy[locale]; const issue = issueCopy[locale]; const audienceText = audienceCopy[locale];
