...
const copy = {
  tr: {
    ...
    steps: [["1", "Profilinizi düzenleyin", "Görünen ad, kullanıcı adı ve açık/gizli profil seçimi bu sekmede saklanır."], ["2", "Gönderiyi güvenle hazırlayın", "Yerel filtre kişisel veri, sır, spam ve uygunsuz dil sinyallerini önceden kontrol eder."], ["3", "Nasıl paylaşacağınızı seçin", "Cihaz panosu, bağlantı, paket veya doğrudan P2P seçeneklerinden uygun olanı kullanın."]],
  },
  en: {
    ...
    steps: [["1", "Set up your profile", "Display name, handle, and public/private choice stay in this tab."], ["2", "Prepare a safer post", "A local filter pre-checks personal-data, secret, spam, and abusive-language signals."], ["3", "Choose how to share", "Use the device board, a link, a pack, or direct P2P according to the audience."]],
  },
  de: {
    ...
    steps: [["1", "Profil einrichten", "Anzeigename, Kürzel und Sichtbarkeit bleiben in diesem Tab."], ["2", "Sicheren Beitrag vorbereiten", "Der lokale Filter prüft Signale für Personendaten, Geheimnisse, Spam und Missbrauch."], ["3", "Teilungsweg wählen", "Je nach Zielgruppe Geräte-Board, Link, Paket oder direktes P2P nutzen."]],
  },
  zh: {
    ...
    steps: [["1", "设置资料", "显示名称、用户名和公开/私密选择留在当前标签页。"], ["2", "安全准备帖子", "本地过滤器会预检个人数据、密钥、垃圾内容和不当语言信号。"], ["3", "选择分享方式", "按受众选择设备看板、链接、内容包或直接 P2P。"]],
  },
} as const;
