...
const pageExperienceCopy = {
  tr: {
    ...
    intro: "Önce herkese açık fikirleri, soruları ve iş akışlarını okuyun. Katılmak istediğinizde yalnızca cihazınızda korunan profilinizi oluşturun; özel notlar ve birebir görüşme seçenekleri daha sonra açılır.",
    read: "Akışı oku",
    publish: "Paylaşım yap",
    privateTools: "Gelişmiş ve özel araçlar",
    advancedTitle: "Gelişmiş / özel topluluk araçları",
    advancedBody: "Yalnızca cihazınızda kalacak taslakları yönetin veya belirli biriyle geçici birebir görüşme başlatın.",
  ...
  en: {
    ...
    intro: "Start by reading public ideas, questions, and workflows. When you want to join, create a profile protected only on your device; private notes and one-to-one sessions stay out of the way until you need them.",
    read: "Read the feed",
    publish: "Create a post",
    privateTools: "Advanced and private tools",
    advancedTitle: "Advanced / private community tools",
    advancedBody: "Manage drafts that stay on this device, or start a temporary one-to-one session with a specific person.",
  ...
  de: {
    ...
    intro: "Lesen Sie zuerst öffentliche Ideen, Fragen und Abläufe. Zum Mitmachen erstellen Sie ein nur auf Ihrem Gerät geschütztes Profil; private Notizen und direkte Gespräche erscheinen erst bei Bedarf.",
    read: "Feed lesen",
    ...
    advancedBody: "Verwalten Sie Entwürfe nur auf diesem Gerät oder starten Sie ein zeitlich begrenztes direktes Gespräch.",
  ...
  zh: {
    ...
    intro: "先浏览公开的想法、问题与工作流。需要参与时，再创建仅在本设备上受保护的资料；私密笔记与一对一会话只在需要时出现。",
    read: "阅读动态",
    publish: "发布内容",
    privateTools: "高级与私密工具",
    advancedTitle: "高级 / 私密社区工具",
    advancedBody: "管理仅保存在本设备上的草稿，或与指定用户发起临时一对一会话。",
    howTitle: "三步参与社区",
