...
export function SiteShell({ children, locale, alternateHref, languageHrefs }: { children: ReactNode; locale: Locale; alternateHref: string; languageHrefs?: Partial<Record<Locale, string>> }) {
  ...
  const globalSchema = {
    ...
    "@graph": [
      { "@type": "Organization", "@id": organizationId, name: "ByteQuant", url: `${siteUrl}/`, logo: { "@type": "ImageObject", url: `${siteUrl}/favicon.png`, width: 512, height: 512 }, email: "bytequant@yahoo.com", description: "Privacy-first browser tools and local productivity software.", foundingDate: "2026", knowsLanguage: ["tr", "en", "de", "zh-CN"], knowsAbout: ["browser privacy", "local data processing", "developer tools", "document conversion", "prompt engineering"], contactPoint: { "@type": "ContactPoint", email: "bytequant@yahoo.com", contactType: "customer support", availableLanguage: ["Turkish", "English", "German", "Simplified Chinese"] }, ethicsPolicy: `${siteUrl}/gizlilik-politikasi`, publishingPrinciples: `${siteUrl}/hakkimizda`, sameAs: ["https://github.com/byte-quant/bytequant", "https://x.com/byte_quant", "https://www.instagram.com/byte.quant"] },
