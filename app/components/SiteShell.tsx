      ...
      <header className="site-header">
        <div className="container header-inner">
          ...
          <nav className="main-nav" aria-label={localized("Ana menü", "Main navigation", "Hauptnavigation", "主导航") }>
            ...
            <Link className="nav-product-link agent-nav-link" href={pathFor(locale, "agent")}><span aria-hidden="true">✦</span><b>ByteQuant AI</b></Link>
            ...
            <details className="mobile-menu">
              ...
              <div className="mobile-menu-panel">
                ...
                <div className="mobile-menu-product-grid">
                  ...
                  <Link className="agent-nav-link" href={pathFor(locale, "agent")}><b>✦</b><span><strong>ByteQuant AI</strong><small>{localized("Hedefi plana çevir", "Turn a goal into a plan", "Ziel in Plan umwandeln", "把目标变成计划")}</small></span></Link>
