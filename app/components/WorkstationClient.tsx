...
const templateDefinitions = [
  ...
  { id: "api", names: { tr: "API teslim kontrolü", en: "API delivery review", de: "API-Auslieferungsprüfung", zh: "API 交付检查" }, slugs: ["openapi-endpoint-envanteri", "json-schema-olusturucu", "http-guvenlik-basliklari-denetleyici"] },
  { id: "frontend", names: { tr: "Responsive arayüz kalite kapısı", en: "Responsive UI quality gate", de: "Responsive-UI-Qualitätsprüfung", zh: "响应式界面质量检查" }, slugs: ["renk-kontrast-denetleyici", "css-clamp-olusturucu", "en-boy-orani-hesaplayici"] },
  { id: "dataset", names: { tr: "Akış verisi hazırlama", en: "Streaming dataset prep", de: "Streaming-Datensatz vorbereiten", zh: "流式数据集准备" }, slugs: ["json-lines-donusturucu", "json-pointer-gezgini", "semver-karsilastirici"] },
  { id: "schedule", names: { tr: "Ekip ve tarih planlama", en: "Team and date planning", de: "Team- und Terminplanung", zh: "团队与日期规划" }, slugs: ["zaman-dilimi-toplanti-planlayici", "is-gunu-hesaplayici", "markdown-tablo-olusturucu"] },
] as const;
