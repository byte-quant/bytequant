...
const description = "Metin, veri, PDF, görsel, hesaplama, kod ve gizlilik işleri için 342 ücretsiz tarayıcı aracı. Arayın, kategori seçin ve üyelik olmadan başlayın.";
