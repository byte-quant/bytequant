...
export const metadata: Metadata = { title, description, robots: nonIndexableRobots, alternates: localizedAlternates("tr", pathFor("tr", "news"), pathFor("en", "news")), ...localizedSocialMetadata("tr", title, description, pathFor("tr", "news")) };
