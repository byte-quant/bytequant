...
export default function sitemap(): MetadataRoute.Sitemap {
  const updated = new Date("2026-07-22T09:00:00+03:00");
  const staticKeys = ["home", "agent", "workstation", "community", "blog", "about", "privacy", "cookies", "terms", "contact", "faq"] as const;
