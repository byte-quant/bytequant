...
const description = "Beschreiben Sie Ihr Ziel und erstellen Sie einen nachvollziehbaren, nutzergesteuerten Ablauf über 211 ByteQuant-Werkzeuge – ohne Remote-Modell oder Upload.";
