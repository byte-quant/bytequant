...
const description = "Beschreiben Sie Ihr Ziel und erstellen Sie einen nachvollziehbaren, nutzergesteuerten Ablauf über 234 eigenständige ByteQuant-Werkzeuge – ohne Remote-Modell oder Upload.";
