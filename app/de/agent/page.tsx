...
const description = "Beschreiben Sie Ihr Ziel und erstellen Sie einen nachvollziehbaren, nutzergesteuerten Ablauf über 131 ByteQuant-Werkzeuge – ohne Remote-Modell oder Upload.";
