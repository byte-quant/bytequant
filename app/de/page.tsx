...
export const metadata: Metadata = {
  ...
  description: "186 kostenlose Werkzeuge für Daten, Dateien, Forschung, Berechnungen, KI-Workflows und Code-Sicherheits-Vorprüfungen. Kernverarbeitung bleibt im Browser.",
  alternates: localizedAlternates("de", "/", "/en"),
  openGraph: { type: "website", siteName: "ByteQuant", locale: "de_DE", alternateLocale: ["tr_TR", "en_US", "zh_CN"], url: absoluteUrl("/de"), title: "ByteQuant · Datenschutzorientierte Browser-Werkzeuge", description: "186 kostenlose Werkzeuge ohne Konto oder Server-Upload.", images: [{ url: ogImageUrl, width: 1200, height: 630, alt: "ByteQuant Datenschutzwerkzeuge" }] },
