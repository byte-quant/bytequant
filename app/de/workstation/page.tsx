...
const description = "317 eigenständige ByteQuant-Werkzeuge visuell verbinden, Projekte lokal verschlüsseln und per URL-Rezept oder serverlosem WebRTC teilen.";
