  ...
  de: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "4. Lokaler Speicher, Community, Meldungen und Einwilligung", paragraphs: ["bq-consent-v1 speichert die Auswahl für 180 Tage und bq-theme das Farbschema. bq-tool-usage-v1 sowie bq-tool-favorites-v1 werden nur nach Einwilligung aktiviert und enthalten Werkzeugkennungen, Zähler, Zeitpunkte oder Favoriten – nie Eingaben oder Ergebnisse. bytequant:news-favorites:v1 enthält nur ausdrücklich gespeicherte Karten-IDs.", "Werkzeugübergaben und Agentengespräche bleiben zeitlich begrenzt im sessionStorage desselben Tabs. Lokales Profil, Beiträge, Reaktionen, Merklisten und Kommentare der Community bleiben ebenfalls in diesem Tab und können über Inhaltslinks oder geprüfte JSON-Pakete übertragen werden. P2P-Chat funktioniert nach Sicherheitscodevergleich nur zwischen verbundenen Browsern; es gibt kein Konto-, Präsenz- oder Nachrichtenarchiv und der Verlauf endet mit der Sitzung. GitHub bleibt optional für dauerhafte Veröffentlichung.", "Der Meldungsfeed übernimmt beim Build nur Titel, Datum, Quellenname, Originalsprache und Originallink aus freigegebenen offiziellen NASA-, NIST- und offen lizenzierten GOV.UK-Feeds; Volltexte und Bilder werden nicht erneut veröffentlicht. Analytik-, Werbe- oder Tracking-SDKs sind nicht aktiv."] },
    ...
    faq: {
      ...
      sections: [
        ...
        { heading: "Sind Community und Meldungen ein globales soziales Netzwerk?", paragraphs: ["Nein. ByteQuant betreibt keine Konto-, Follower-, Präsenz- oder dauerhafte Nachrichtendatenbank. Lokale Profile, Beiträge, Reaktionen, Merklisten und Kommentare bleiben im Tab und können über Inhaltslinks oder geprüfte portable Pakete weitergegeben werden. GitHub Discussions ist optional für dauerhafte Veröffentlichung. P2P-Chat gilt nur für die verifizierte Sitzung zwischen zwei offenen Browsern. Meldungen zeigen nur Titel, Datum, Quelle, Originalsprache und Originallink aus offiziellen NASA-, NIST- und offen lizenzierten GOV.UK-Feeds."] },
      ],
    },
  },
  zh: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "4. 本地存储、社区、动态与同意", paragraphs: ["bq-consent-v1 保存 180 天的选择，bq-theme 保存所选主题。bq-tool-usage-v1 与 bq-tool-favorites-v1 仅在同意后启用，只包含工具标识、次数、最后使用时间或收藏，不包含内容。bytequant:news-favorites:v1 仅保存您主动收藏的卡片 ID。", "社区的本地资料、帖子、互动、收藏与评论保留在当前标签页，可通过携带内容的链接或经验证的 JSON 包转交。P2P 聊天仅在双方核对安全码后于已连接浏览器之间运行；没有账户、在线状态或消息归档服务器，关闭会话后历史消失。GitHub 仅用于可选的长期公开发布。", "动态页只在构建时从获准的 NASA、NIST 与开放许可 GOV.UK 官方 Feed 获取标题、日期、来源名、原始语言和原始链接，不转载全文或图片。当前没有启用分析、广告或跟踪 SDK。"] },
    ...
    faq: {
      ...
      sections: [
        ...
        { heading: "社区和动态是全球社交网络吗？", paragraphs: ["不是。ByteQuant 不运营账户、关注者、在线状态或永久消息数据库。本地资料、帖子、互动、收藏与评论保留在当前标签页，可通过内容链接或经验证的便携包转交。GitHub Discussions 可用于可选的长期发布。P2P 聊天仅在两台已核对安全码的开放浏览器之间于会话期间运行。动态页只显示 NASA、NIST 与开放许可 GOV.UK Feed 的标题、日期、来源、原始语言和原始链接。"] },
      ],
    },
  },
};
