  ...
  de: {
    ...
    cookies: {
      ...
      sections: [
        ...
        { heading: "Sitzungsplan des lokalen Agenten", paragraphs: ["Der Schlüssel bytequant:local-agent:v1 liegt ausschließlich im sessionStorage des offenen Tabs und kann Ziel, Plan und ausdrücklich übernommene Zwischenausgaben enthalten. Er wird nicht mit optionalen Nutzungszählern verknüpft und endet mit der Tab-Sitzung."] },
  ...
  zh: {
    ...
    cookies: {
      ...
      sections: [
        ...
        { heading: "本地助手的标签页会话", paragraphs: ["bytequant:local-agent:v1 只存在于当前标签页的 sessionStorage，可能包含目标、计划及您明确接收的中间输出；它不会与可选工具计数关联，并随标签页会话结束。"] },
    ...
    faq: {
      ...
      sections: [
        ...
        { heading: "德语和中文是否完整支持？", paragraphs: ["导航、全部 309 个互不重复的工具页面、核心页面、元数据和结构化数据已本地化。扩展后的工作流指南库提供德语与中文版本；其他既有文章会明确标注为英文原文。"] },
