  ...
  de: {
    ...
    faq: {
      ...
      sections: [
        ...
        { heading: "Sind Community und Meldungen ein globales soziales Netzwerk?", paragraphs: ["Nein. ByteQuant betreibt keine Konto-, Profil-, Follower-, Präsenz- oder dauerhafte Nachrichtendatenbank. Lokale Beiträge bleiben auf diesem Gerät; GitHub Discussions ist optional für dauerhafte Veröffentlichung. P2P-Chat gilt nur für die verifizierte Sitzung zwischen zwei offenen Browsern. Meldungen zeigen nur Titel, Datum und Originallink aus offiziellen NASA-/NIST-RSS-Einträgen."] },
      ],
    },
  },
  zh: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: "4. 本地存储、社区、动态与同意", paragraphs: ["bq-consent-v1 保存 180 天的选择，bq-theme 保存所选主题。bq-tool-usage-v1 与 bq-tool-favorites-v1 仅在同意后启用，只包含工具标识、次数、最后使用时间或收藏，不包含内容。bytequant:news-favorites:v1 仅保存您主动收藏的卡片 ID。", "社区草稿在本标签页预检查。P2P 聊天仅在双方核对安全码后于已连接浏览器之间运行；没有账户、在线状态或消息归档服务器，关闭会话后历史消失。GitHub 仅用于可选的长期公开发布。", "动态页只在构建时从获准的 NASA/NIST 官方 RSS 获取标题、日期、来源名和原始链接，不转载全文或图片。当前没有启用分析、广告或跟踪 SDK。"] },
    ...
    faq: {
      ...
      sections: [
        ...
        { heading: "社区和动态是全球社交网络吗？", paragraphs: ["不是。ByteQuant 不运营账户、资料、关注者、在线状态或永久消息数据库。本地帖子保留在本设备；GitHub Discussions 可用于可选的长期发布。P2P 聊天仅在两台已核对安全码的开放浏览器之间于会话期间运行。动态页只显示 NASA/NIST 官方 RSS 的标题、日期和原始链接。"] },
      ],
    },
  },
};
