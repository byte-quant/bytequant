  ...
  zh: {
    ...
    faq: {
      ...
      sections: [
        ...
        { heading: "德语和中文是否完整支持？", paragraphs: ["导航、全部 62 个工具页面、核心页面、元数据和结构化数据已本地化。三个全新详细工作流已完成德语与中文编辑本地化；其他既有文章会明确标注为英文原文。"] },
