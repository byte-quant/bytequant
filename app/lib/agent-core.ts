...
const recipes: Recipe[] = [
  ...
  { test: [/(csp|content security policy)/i, /(merge|birleştir|combine|zusammenführ|合并)/i], steps: ["csp-direktif-birlestirici", "sri-hash-olusturucu"], signal: { tr: "CSP birleştirme ve kaynak bütünlüğü ön kontrolü", en: "CSP merge and resource-integrity preflight", de: "CSP-Zusammenführung und Integritäts-Vorprüfung", zh: "CSP 合并与资源完整性预检" } },
