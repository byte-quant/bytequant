...
export const tools: Tool[] = [...baseTools, ...demandTools, ...discoveryTools, ...productivityTools, ...expansionTools, ...essentialTools, ...precisionTools, ...frontierTools, ...stageTwoTools].map(localizeTool);
