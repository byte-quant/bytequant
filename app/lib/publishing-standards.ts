...
export const publishingStandards: Record<Locale, PublishingStandardsCopy> = {
  tr: {
    ...
    evidence: [
      { value: "327", label: "benzersiz araç", detail: "Her biri yöntem, sınır ve kullanım adımlarıyla yayımlanır." },
  ...
  en: {
    ...
    evidence: [
      { value: "327", label: "distinct tools", detail: "Each publishes its method, limits, and usage steps." },
  ...
  de: {
    ...
    evidence: [
      { value: "327", label: "eigenständige Werkzeuge", detail: "Mit Methode, Grenzen und Nutzungsschritten." },
  ...
  zh: {
    ...
    evidence: [
      { value: "327", label: "个独立工具", detail: "每个工具都公开方法、限制和使用步骤。" },
