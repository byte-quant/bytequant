...
const description = "317 benzersiz ByteQuant aracını görsel düğümlerle bağlayın; projeleri cihazda şifreleyin, URL tarifleri ve sunucusuz WebRTC ile paylaşın.";
