...
const description = "234 benzersiz ByteQuant aracını görsel düğümlerle bağlayın; projeleri cihazda şifreleyin, URL tarifleri ve sunucusuz WebRTC ile paylaşın.";
