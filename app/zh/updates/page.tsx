...
export const metadata: Metadata = { title, description, robots: nonIndexableRobots, alternates: localizedAlternates("zh", pathFor("tr", "news"), pathFor("en", "news")), ...localizedSocialMetadata("zh", title, description, pathFor("zh", "news")) };
